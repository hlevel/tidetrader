...
public class OrderDTO {
    ...
    public String getDescription() {
        return timestamp.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")) + " " + this.orderId  /*+ " " + this.currencyPair*/ + " " + this.averagePrice.getValue().stripTrailingZeros().toPlainString() + " " + this.type + " " + this.amount.getValue().stripTrailingZeros().toPlainString() + " " + this.status;
    }
