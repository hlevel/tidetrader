...
public interface CassandreStrategyInterface {
    ...
    /**
     * Returns the last TickerDTO received for a currency pair.
     *
     * @param currencyPair currency pair
     * @return last TickerDTO
     */
    Optional<TickerDTO> getLastTickerByCurrencyPair(final CurrencyPairDTO currencyPair);
}
