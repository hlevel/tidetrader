package tide.trader.bot.util.jpa;
...
import static tide.trader.bot.configuration.DatabaseAutoConfiguration.PRECISION;
import static tide.trader.bot.configuration.DatabaseAutoConfiguration.SCALE;
