...
public class Position extends BaseDomain {
    ...
    /** Position rules - stop gain percentage. */
    @Column(name = "RULES_STOP_GAIN_BOUNCE_PERCENTAGE")
    private Float stopGainBouncePercentageRule;
    ...
    public final boolean equals(final Object o) {
        ...
        return new EqualsBuilder()
                ...
                .append(this.stopGainBouncePercentageRule, that.stopGainBouncePercentageRule)
