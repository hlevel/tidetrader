...
@ConditionalOnProperty(
        value = BaseTest.PARAMETER_ONLY_POSITIONS_STRATEGY_ENABLED,
        havingValue = "true")
public final class OnlyPositionsStrategy extends BasicCassandreStrategy {
    ...
    public Set<CurrencyPairDTO> getRequestedCurrencyPairs() {
        return Collections.singleton(BaseTest.BTC_USDT);
    }
    ...
    public void onTickersUpdates(final Map<CurrencyPairDTO, TickerDTO> tickers) {
        ...
        if (tickerBTCUSDT != null) {
            ...
            if (tickerBTCUSDT.getLast().compareTo(new BigDecimal("20000")) == 0) {
                ...
                final PositionCreationResultDTO position1Result = createLongPosition(BaseTest.BTC_USDT,
                        new BigDecimal("2"),
            ...
            if (tickerBTCUSDT.getLast().compareTo(new BigDecimal("40000")) == 0) {
                ...
                final PositionCreationResultDTO position1Result = createShortPosition(BaseTest.BTC_USDT,
                        new BigDecimal("1"),
