...
import org.knowm.xchange.binance.perpetualswap.service.BinancePerpetualAccountService;
import org.knowm.xchange.binance.perpetualswap.service.BinancePerpetualMarketDataService;
import org.knowm.xchange.binance.perpetualswap.service.BinancePerpetualTradeService;
...
public class BinanceExchange extends BaseExchange {
  ...
  protected BinancePerpetualAuthenticated binancePerpetual;
  protected SynchronizedValueFactory<Long> timestampFactory;

  @Override
  protected void initServices(Domain domain) {
    ...
    switch (domain){
      case SPOT:
        ...
        break;
      case PERPETUAL:
        this.binancePerpetual = ExchangeRestProxyBuilder.forInterface(BinancePerpetualAuthenticated.class, getExchangeSpecification()).build();
        this.marketDataService = new BinancePerpetualMarketDataService(this, binancePerpetual, getResilienceRegistries());
        this.tradeService = new BinancePerpetualTradeService(this, binancePerpetual, getResilienceRegistries());
        this.accountService = new BinancePerpetualAccountService(this, binancePerpetual, getResilienceRegistries());
        break;
    }
  }
  ...
  public ExchangeSpecification getDefaultExchangeSpecification() {
    return getDefaultExchangeSpecification(Domain.SPOT);
  }
  */
  ...
  @Override
  public void applySpecification(ExchangeSpecification exchangeSpecification, Domain domain) {
    concludeHostParams(exchangeSpecification);
    super.applySpecification(exchangeSpecification, domain);
  }
  ...
  public void remoteInit() {
    ...
    try {
      if(this.marketDataService instanceof BinancePerpetualMarketDataService) {
        BinancePerpetualMarketDataService perpetualMarketDataService = (BinancePerpetualMarketDataService) this.marketDataService;
        exchangeInfo = perpetualMarketDataService.getExchangeInfo();
      } else {
      ...
      if(getAccountService() instanceof BinancePerpetualAccountService) {
        BinancePerpetualAccountService perpetualAccountService = (BinancePerpetualAccountService) getAccountService();
        assetDetailMap = new HashMap<>();
      } else {
