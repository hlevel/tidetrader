...
public class BinanceMarketDataServiceRaw extends BinanceBaseService {
  ...
  public List<Kline> klines(CurrencyPair pair, KlineInterval interval, Integer limit, Long startTime, Long endTime)
      throws IOException {
    List<Object[]> raw =
        decorateApiCall(
            ...
            .call();
    return raw.stream()
        .map(obj -> new Kline.Builder().from(pair, obj).build())
