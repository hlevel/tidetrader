...
public class TestSimulatedExchange {
  ...
  public void setup() throws IOException {
    ...
    exchange = (SimulatedExchange) ExchangeFactory.INSTANCE.createExchange(exchangeSpecification, Domain.SPOT);
  ...
  public void testTradeHistoryIsolation() throws IOException {
    ...
    exchangeSpecification.setExchangeSpecificParametersItem(
        ENGINE_FACTORY_PARAM, matchingEngineFactory);
    Exchange someoneElsesExchange = ExchangeFactory.INSTANCE.createExchange(exchangeSpecification, Domain.SPOT);
  ...
  private void mockMarket() throws IOException {
    ...
    SimulatedExchange marketMakerExchange =
        (SimulatedExchange) ExchangeFactory.INSTANCE.createExchange(exchangeSpecification, Domain.SPOT);
