...
public class SimulatedExchangeExample {
  ...
  public void complex() throws IOException {
    ...
    SimulatedExchange makerEx =
        (SimulatedExchange) ExchangeFactory.INSTANCE.createExchange(makerSpec, Domain.SPOT);
    ...
    SimulatedExchange takerEx =
        (SimulatedExchange) ExchangeFactory.INSTANCE.createExchange(takerSpec, Domain.SPOT);
