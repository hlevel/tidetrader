...
public interface TradeService extends BaseService {
   ...
   * 调整开仓杠杆
   */
  default void setLeverage(CurrencyPair currencyPair, Integer leverage) throws IOException {
    throw new NotYetImplementedForExchangeException();
  }
   ...
   * 下多个订单
   *
  default List<String> placeLimitOrders(List<LimitOrder> limitOrders) throws IOException {
    throw new NotYetImplementedForExchangeException();
  }*/
   ...
   * 撤销单个订单
   *
  default String placeMarketOrders(List<MarketOrder> marketOrder) throws IOException {
    throw new NotYetImplementedForExchangeException();
  }*/
   ...
   * 根据合约名称撤销关于此合约的所有订单
   *
  default void cancelAllByInstrument(CurrencyPair currencyPair) throws IOException {
    throw new NotYetImplementedForExchangeException();
  }*/
