...
public final class Balance implements Comparable<Balance>, Serializable {
  ...
  /** Short amount */
  private final BigDecimal shorted;
  ...
  public static class Builder {
    ...
    public Builder shorted(BigDecimal shorted) {
    ...
    public Balance build() {
      ...
      return new Balance(
          currency, total, available, frozen, borrowed, loaned, withdrawing, depositing, shorted, timestamp);
    }
  }
}
