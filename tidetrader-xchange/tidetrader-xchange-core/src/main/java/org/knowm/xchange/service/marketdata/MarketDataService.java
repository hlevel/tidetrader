...
public interface MarketDataService extends BaseService {
   ...
   * @throws IOException - Indication that a networking error occurred while fetching JSON data
   */
  default Kline getKline(Instrument instrument, Object... args) throws IOException {
    throw new NotYetImplementedForExchangeException("getKline");
  }
   ...
   * @throws IOException - Indication that a networking error occurred while fetching JSON data
   */
  default List<Kline> getKlines(Params params) throws IOException {
  ...
  default List<Ticker> getTicker(Params params) throws IOException {
    throw new NotYetImplementedForExchangeException("getTickers");
  }

  default Ticker getTicker(Instrument instrument) throws IOException {
    throw new NotYetImplementedForExchangeException("getTicker24h");
  }
