...
public abstract class BaseExchange implements Exchange {
  ...
  protected abstract void initServices(Domain domain);
  ...
  public void applySpecification(ExchangeSpecification exchangeSpecification, Domain domain) {
    ...
    switch (domain) {
      case SPOT:
        this.exchangeSpecification.setSslUri("https://api.binance.com");
        break;
      case PERPETUAL:
        this.exchangeSpecification.setSslUri("https://fapi.binance.com");
        break;
    }
