...
public enum ExchangeFactory {
   ...
   */
  public Exchange createExchange(Domain domain, String exchangeClassName) {

    return createExchange(domain, exchangeClassName, null, null);
  }
   ...
   *     org.knowm.xchange.ExchangeSpecification}
   */
  public <T extends Exchange> T createExchange(Class<T> exchangeClass, Domain domain) {

    return createExchange(exchangeClass, null, null, domain);
  }
   ...
   *     org.knowm.xchange.ExchangeSpecification}
   */
  public Exchange createExchange(Domain domain, String exchangeClassName, String apiKey, String secretKey) {
    ...
    exchange.applySpecification(defaultExchangeSpecification, domain);
  ...
  public <T extends Exchange> T createExchange(
      Class<T> exchangeClass, String apiKey, String secretKey, Domain domain) {
   ...
   *     org.knowm.xchange.ExchangeSpecification}
   */
  public Exchange createExchange(ExchangeSpecification exchangeSpecification, Domain domain) {
    ...
    exchange.applySpecification(exchangeSpecification, domain);
    return exchange;
  }
